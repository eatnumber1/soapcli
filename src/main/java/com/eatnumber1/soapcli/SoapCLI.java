...
public class SoapCLI {
    ...
    public static void main( String[] args ) throws Exception {
        ...
        Option verboseOption = new Option("v", "verbose", false, messages.getMessage("com.eatnumber1.soapcli.option.help.verbose"));
        Option debugOption = new Option("d", "debug", false, messages.getMessage("com.eatnumber1.soapcli.option.help.debug"));
        Option helpOption = new Option("h", "help", false, messages.getMessage("com.eatnumber1.soapcli.option.help.help"));
        ...
        if( cmd.hasOption(helpOption.getLongOpt()) ) {
            ...
            formatter.printHelp(messages.getMessage("com.eatnumber1.soapcli.usage"), options);
            System.exit(0);
        }
    ...
    public void run() throws Exception {
        CyclicBarrier barrier = server.start();
        //controller.play();
        barrier.await();
        Thread.sleep(1000);
        server.stop();
